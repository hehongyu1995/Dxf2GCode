...
class ReadDXF(QtCore.QObject):
    ...
    def get_geo_entitie(self, geo_nr, name):
        ...
        if name == "POLYLINE":
            ...
            logger.info(self.tr("--Got a POLYLINE!"))
        elif name == "SPLINE":
            geo = GeoentSpline(geo_nr, self)
            logger.info(self.tr("--Got a SPLINE!"))
        elif name == "ARC":
            geo = GeoentArc(geo_nr, self)
            logger.info(self.tr("--Got a ARC!"))
        elif name == "CIRCLE":
            ...
            logger.info(self.tr("--Got a INSERT!"))
        elif name == "ELLIPSE":
            geo = GeoentEllipse(geo_nr, self)
            logger.info(self.tr("--Got a ELLIPSE!"))
        elif name == "LWPOLYLINE":
            geo = GeoentLwPolyline(geo_nr, self)
            logger.info(self.tr("--Got a LEPOLYLINE!"))
        elif name == "POINT":
            logger.info(self.tr("--Got a POINT!"))
